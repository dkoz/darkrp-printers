	...
	if self.IsValid then
		...
		timer.Simple( 2, function()
			if coolerempty <= 0 then
				self.damage = self.damage - math.random( 5, 10 )
				self:SetNWInt( "Health", self.damage )
			end
		end )
	end
